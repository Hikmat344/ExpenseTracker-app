  ...
  return (
    <div>
        ...
        <div className='mt-4 '>
            ...
            <input className='w-full px-2 h-10 mt-2 bg-slate-100 border-2 border-gray-200 rounded-md' value={description} type='text' placeholder='Detail of Transaction '></input>
            ...
            <button type='submit' className='items-center bg-blue-600 text-white w-full h-12 mt-3'>Add Transaction</button>
